...
export const UI_ADD_CURRENT = 'UI_ADD_CURRENT'; //deprecate
export const UI_SET_CURRENT = 'UI_SET_CURRENT'; //deprecate
export const UI_TOGGLE_CURRENT = 'UI_TOGGLE_CURRENT'; //deprecate
export const UI_SET_CURRENT_CONSTRUCT = 'UI_SET_CURRENT_CONSTRUCT'; //deprecate
